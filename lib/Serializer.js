// Import baileys as default and destructure from it
import baileys from "@whiskeysockets/baileys";
import { makeInMemoryStore } from "@whiskeysockets/baileys/lib/store/memory";
...
sock.downloadMediaMessage = async (message) => {
    ...
    sock.copyNForward = async (jid, message, forceForward = false, options = {}) => {
        ...
        // Fix: Use generateWAMessageFromContent which we imported
